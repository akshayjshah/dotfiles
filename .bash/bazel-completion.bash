...
--experimental_json_profile_metadata
--noexperimental_json_profile_metadata
...
--noincompatible_disallow_old_octal_notation
...
--noincompatible_disallow_rule_execution_platform_constraints_allowed
...
--noincompatible_no_kwargs_in_build_files
...
--noincompatible_objc_framework_cleanup
...
--noincompatible_static_name_resolution_in_build_files
...
--experimental_remote_download_outputs={all,minimal,toplevel}
